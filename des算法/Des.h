...
public:
	...
	bitset<32> sBox(bitset<48>R);
	bitset<32> pConvert(bitset<32>R);
	bitset<56> pc_1Convert(bitset<64>R);
	bitset<48> pc_2Convert(bitset<56>R);
	bitset<64> ipConvert(bitset<64>R);
	bitset<64> ip_1Convert(bitset<64>R);
};
